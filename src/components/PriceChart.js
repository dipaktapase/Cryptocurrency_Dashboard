      ...
      <div className="flex absolute lg-gap-3 items-center lg-ml-48 ml-16 gap-2 lg-left-34 left-4 md:mt-3 lg:mt-3 sm:mt-3 mt-3">
        ...
        <div className="flex absolute items-center rounded-md p-2  md:w-44 w-36 lg:left-[22rem] lg:mt-1 md:left-[22rem] md:mt-1 sm:right-[6rem] mt-20 ml-2">
          <select
            ...
            className="w-full relative h-10 bg-gray-50 hover:bg-gray-100 font-semibold py-2 text-transform: capitalize outline-none shadow rounded"
          ...
          <div className="rounded-md bg-opacity-30 p-2 absolute lg:left-[10rem] md:left-[10rem] left-[8rem] sm:left-[8rem] md:w-36 w-28 ml-5">
            <select
              value={chartType}
